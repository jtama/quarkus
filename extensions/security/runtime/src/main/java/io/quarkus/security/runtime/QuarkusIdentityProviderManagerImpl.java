...
public class QuarkusIdentityProviderManagerImpl implements IdentityProviderManager {
                ...
                public Uni<SecurityIdentity> get() {
                    if (BlockingOperationControl.isBlockingAllowed()) {
                        ...
                        Uni<SecurityIdentity> uni = Uni.createFrom()
                                .emitter(new Consumer<UniEmitter<? super SecurityIdentity>>() {
                                    @Override
                        ...
                        if (eventLoopExecutor != null) {
                            uni = uni.emitOn(eventLoopExecutor);
                        }
                        return uni;
                    }
                }
    ...
    QuarkusIdentityProviderManagerImpl(Builder builder) {
        ...
        this.eventLoopExecutor = builder.eventLoopExecutor;
    }
    ...
    public static class Builder implements IdentityProviderManagerBuilder<Builder> {
        ...
        private Executor eventLoopExecutor;
        ...
        public Builder setEventLoopExecutor(Executor eventLoopExecutor) {
